...
▸ Contoh : #daftar ${user}.13`*/
  ...
  if (msg) return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "buttonText": "Nothing BOT",
          "listType": "SINGLE_SELECT",
          "sections": [
                            {
                                "rows": [{
                                         "title": `MY OWNER`,
                                         "description": "List Owner Nothing BOT",
                                         "rowId": ".nowner"
                                    }, {
                                         "title": `ABOUT`,
                                         "description": " Tentang Nothing BOT", 
                                         "rowId": ".info"
                                    }, {
                                         "title": `LIST MENU`,
                                         "description": " List Menu Nothing BOT",
                                         "rowId": ".menu"
                                    }, {
                                         "title": `SCRIPT`,
                                         "description": " Source code Nothing BOT",
                                         "rowId": ".sc"
                                         }, {
                                         "title": `GROUP BOT`,
                                         "description": " List Group Official Nothing BOT",
                                         "rowId": ".gcbot"
                       }],
                    "title": "Created By Nothing"
                  }
                        ], "contextInfo": 
                         { "stanzaId": m.key.id,
